...
function EditAvatarPopup({isOpen, onClose, onUpdateAvatar}) {
  ...
  return (
    ...
    <div className="popup__input-container">
      <input type="url" name='link' ref={avatarRef} id="picLink" placeholder="Ссылка на картинку" className="popup__input-text popup__input-text_action_add-profile-picture" required />
